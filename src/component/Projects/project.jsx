                ...
                <div className="projectMotion">
                    ...
                    <div className="categorySec">
                        <div className="projCategory ">
                            <button onClick={() => setClick("one")} className={`catLink fw-semibold btnDev ${click === "one" ? "btnActive" : ""}`}>DEVELOPMENT</button>
                            <button onClick={() => setClick("two")} className={`catLink fw-semibold btnDev ${click === "two" ? "btnActive" : ""}`}>UIUX</button>
                            <button onClick={() => setClick("three")} className={`catLink fw-semibold btnDev ${click === "three" ? "btnActive" : ""}`}>GRAPHIC DESIGN</button>
                        </div>
                    </div>
                    {click === "one" ? (

                        <div className="devCetagory projectOne">
                            <div className="devCetagoryOne ">
                                    ...
                                    <div className="projectArea mt-5">
                                        <div className="projectPart">
                                            ...
                                            <div className="projectDescription">
                                                ...
                                                <button class="projectBtn oneBtn" data-index="0" onClick={() => setShow(1)}>See More</button>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="projectArea">
                                        <div className="projectPart projectPartDesk">
                                            <div className="projectDescription2">
                                                ...
                                                <button class="projectBtn oneBtn" data-index="1" onClick={() => setShow(2)}>See More</button>
                                            </div>
                                        ...
                                        <div className="projectPartMob">
                                            ...
                                            <div className="projectDescription2">
                                                ...
                                                <p>Capgs Watches is a modern e-commerce website dedicated to showcasing and selling a premium range of watches. The platform provides users with an intuitive shopping experience, featuring stylish product listings, detailed watch descriptions.</p>
                                                <button class="projectBtn oneBtn" data-index="2" onClick={() => setShow(3)}>See More</button>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="projectArea">
                                        <div className="projectPart">
                                            ...
                                            <div className="projectDescription">
                                                ...
                                                <button class="projectBtn oneBtn" data-index="3" onClick={() => setShow(4)}>See More</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <AnimatePresence>
                                    ...
                                    {show === 1 ? (
                                        <motion.div
                                            className="projectPop"
                                            data-index="0"
                                            initial={{ opacity: 0, scale: 0.8 }}   // start hidden
                                            animate={{ opacity: 1, scale: 1 }}     // fade+zoom in
                                            exit={{ opacity: 0, scale: 0.8 }}      // fade+zoom out
                                        ...
                                        >
                                            <div className="projectPop" data-index="0">
                                                <div className="launchModalProj">
                                                    ...
                                                    <h2 className="close" onClick={() => setShow(0)}>close</h2>
                                                </div>
                                            </div>
                                        </motion.div>
                                    ) : show === 2 ? (
